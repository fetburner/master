\documentclass[english]{sumiilab-paper}
\usepackage{amsmath}
\usepackage{amssymb}
...
% 著者の所属
%\institute{東北大学 \\情報知能システム総合学科}% 学部生
...
%
\begin{lemma}[basic properties of call-by-name evaluation]\label{determinism-of-call-by-name} \qquad
	\begin{enumerate}
...
%
\begin{lemma}[determinacy of call-by-need reductions]\label{determinism-of-call-by-need} \qquad
	\begin{enumerate}
...
%
\begin{lemma}[single-step correspondence]\label{lemma:single-step-soundness} \qquad
	\begin{enumerate}
...
\end{figure}
%
\chapter{Formalization in Coq}\label{sec:formalization}
%
...
%
	...
	\begin{center}
		\begin{minipage}{.45\textwidth}
			\begin{prooftree}
				\AxiomC{}
				\UnaryInfC{$(\lambda .M)N \CALLBYNAME M[0 \mapsto N]$}
			\end{prooftree}
		\end{minipage}
		\begin{minipage}{.45\textwidth}
			\begin{prooftree}
				\AxiomC{}
				\UnaryInfC{$(\lambda .M)N \FULLBETA M[0 \mapsto N]$}
			\end{prooftree}
		\end{minipage}
	\end{center}
%
